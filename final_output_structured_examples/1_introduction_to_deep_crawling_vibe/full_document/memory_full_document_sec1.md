---
id: memory_full_document_sec1
cluster: memory
topic: full_document
title: Introduction to Deep Crawling (`vibe`)
version_context: None
outline_date: None
section_hierarchy: ['Introduction to Deep Crawling (`vibe`)']
keywords: ['\n\n### 1.2. Example: Understanding ', '\n\n### 1.3. Example: Minimal setup for deep crawling a single level deep.\nThis demonstrates the most straightforward way to perform a shallow deep crawl (depth 1).\n\n', ' (depth, parent_url, score) in Deep Crawl Results.\nEach ', ' (if applicable, e.g., with ', ' from a deep crawl contains useful metadata like the crawl ', ' from which it was discovered, and a ', ').\n\n']
description:
file_path: 1_introduction_to_deep_crawling_vibe.md::full_document
---
